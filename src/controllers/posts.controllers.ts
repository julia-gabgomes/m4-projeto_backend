...
const unLikePostController = async (req: Request, res: Response) => {
  ...
  export { createPostController, updatePostController, listAllPostsController, unLikePostController, deletePostController, giveLikeForAPostController, listAllCommentsFromAPostController, listEspecificPostController}